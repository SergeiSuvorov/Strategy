...
namespace UserControlSystem
{
        ...
        : CommandCreatorBase<TCommand> where TCommand : ICommand
    {
        ...
        protected override async void ClassSpecificCommandCreation(ICommandExecutor commandExecutor, Action<TCommand> creationCallback)
        {
        ...
        public void ClassSpecificCommandCreation(TArgument argument)
        {
            Debug.Log(argument.ToString());
           _context.Inject(CreateCommand(argument));
        }
