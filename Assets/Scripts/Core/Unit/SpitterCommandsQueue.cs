...
public class SpitterCommandsQueue : MonoBehaviour, ICommandsQueue
{
    ...
    [Inject] CommandExecutorBase<IConquerCommand> _conquerCommandExecutor;
    ...
    private async void ExecuteCommand(ICommand command)
    {
        ...
        await _conquerCommandExecutor.TryExecuteCommand(command);
